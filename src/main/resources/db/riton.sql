...
ALTER TABLE `tb_shop`
ADD COLUMN `h3hex` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'h3十六进制地理位置哈希值，从经纬度计算' AFTER `y`;
...
ALTER TABLE `tb_user` ADD COLUMN `money` bigint(20) UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE `tb_user` ADD COLUMN `coins` bigint(20) UNSIGNED NOT NULL DEFAULT 0;
